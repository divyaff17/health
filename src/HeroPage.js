      ...
      <main>
        <div className="mx-auto max-w-7xl w-full pt-16 pb-20 text-center">
          <div className="px-4 px-8">
            <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 text-5xl">
              <span className="block">Welcome To</span> <span className="block text-indigo-600">Health Track Web app</span>
            </h1>
            <p className="mt-3 max-w-md mx-auto text-lg text-gray-500 text-xl">
              Health Track is a web app designed to help users monitor their daily health metrics like steps, sleep, heart rate, and
              calories. It offers personalized insights, goal setting, and progress tracking through a clean, intuitive dashboard. With
              real-time data sync from wearables, it empowers users to take control of their well-being.
            </p>
            <div className="mt-10 flex justify-center">
              <div className="mt-3 rounded-md shadow mt-0 ml-3"></div>
              <div className="mt-3 rounded-md shadow mt-0 ml-3"></div>
            </div>
          </div>
        </div>
        <div className="relative w-full h-64 h-72">
          <img
            ...
            src="https://play-lh.googleusercontent.com/Re_MzeuBA0ORt2js6_nPHyBaGRH7o9T7r56YoCtvZ9xvSNXDqHSfC9chE433asZGhg=w600-h300-pc0xffffff-pd"
            alt=""
          />
        </div>
      </main>
